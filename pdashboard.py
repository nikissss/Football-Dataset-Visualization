...
@st.cache_data
def load_data():
    df = pd.read_csv("C:/Users/nikki/Downloads/players.csv")
...
with cluster_tab:
    ...
    fig_cluster = px.scatter(
        ...
        title=f"Player Clustering by {clustering_method}"
    )
...
with club_tab:
    ...
    if len(selected_clubs) >= 2:
        ...
        fig_comp = px.box(compare_df, x='current_club_name', y='market_value_in_eur', color='current_club_name', points='all', title="Club Comparison: Market Value Distribution", height=700)
